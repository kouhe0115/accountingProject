            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('shop.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="start_time" class="col-md-4 col-form-label text-md-right">{{ __('開店時間') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="end_time" class="col-md-4 col-form-label text-md-right">{{ __('閉店時間') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="genre" class="col-md-4 col-form-label text-md-right">{{ __('店のジャンル') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="comment" class="col-md-4 col-form-label text-md-right">{{ __('店舗紹介') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="seats" class="col-md-4 col-form-label text-md-right">{{ __('席数') }}</label>
